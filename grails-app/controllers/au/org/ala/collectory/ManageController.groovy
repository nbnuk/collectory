...
class ManageController {
    ...
    def index = {
        ...
        if ((AuthenticationCookieUtils.cookieExists(request, grailsApplication.config.security.cas.authCookieName) || grailsApplication.config.security.bypass?:''.toBoolean()) && !params.noRedirect) {
